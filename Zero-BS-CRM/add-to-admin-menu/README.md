...
A lightweight WordPress plugin that adds quick access links for "Add New Contact" and "Add New Company" to the WordPress admin bar under the "New" menu for Zero BS CRM (Jetpack CRM).
