...
- Identify the plugin name and slug from the report or from the plugin header comment (e.g. `hello-dolly` from `Plugin Name: Hello Dolly`)
- Resolve the plugin's public URLs:
  - **WordPress.org plugin page**: `https://wordpress.org/plugins/[slug]/` (use the lowercase, hyphenated slug)
  - **GitHub repository**: search the PCP report, plugin header, or plugin website for a GitHub URL; if not provided, note it as unknown
...
## Plugin
- **Name**: [Plugin Name]
- **WordPress.org**: [Plugin Name on WordPress.org](https://wordpress.org/plugins/[slug]/)
- **GitHub**: [GitHub Repository](https://github.com/[owner]/[repo]) _(omit this line if the repository URL is unknown)_
...
- The findings file includes a **Plugin** section with the plugin's WordPress.org URL (`https://wordpress.org/plugins/[slug]/`) and, where available, its GitHub repository URL
